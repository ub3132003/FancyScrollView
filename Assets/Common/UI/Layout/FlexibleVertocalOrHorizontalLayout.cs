...
namespace ListView
{
    ...
    public abstract class FlexibleVertocalOrHorizontalLayout : LayoutGroup
    {
        ...
        public abstract ScrollDirection ScrollDirection { get; }
            ...
            else
            {
                ...
                for (int i = 0; i < rectChildren.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (Anime)
                        {
                            var posOld = axis == 1 ? -rectChildren[i].offsetMax.y : rectChildren[i].offsetMin.x;
                            var duration = axis == 1 ? AnimeYDuration : AnimeXDuration;
                            var tween = DOTween.To(() => posOld, x => SetChildAlongAxisWithScale(child, axis, x, scaleFactor), pos + offsetInCell, duration);
                            if (paramSO != null)
                                tween.SetAs(paramSO.TweenParams);
                        }
                        else
                        {
        ...
        public void GetChildSizes(RectTransform child, int axis, bool controlSize, bool childForceExpand,
